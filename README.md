...
- **Style** — consistent formatting, blank lines around control flow and multiline declarations, braces based on body layout, single-line conditions up to 128 characters, a final newline, and named literal arguments. Includes automatic spacing and brace fixes.
